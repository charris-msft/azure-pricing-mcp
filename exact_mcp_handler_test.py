                ...
                if result["items"]:
                    ...
                    if result["count"] > 0:
                        ...
                        if "sku_validation" in result:
                            ...
                            print(f"  validation keys: {validation.keys() if isinstance(validation, dict) else 'Not a dict'}")
                            ...
                            if validation["suggestions"]:
                                ...
                                print(f"  suggestions length: {len(suggestions) if suggestions is not None else 'None'}")
                                ...
                                if suggestions is not None:
                                    for i, suggestion in enumerate(suggestions[:3]):
                                        ...
                                        if suggestion is not None:
                                            sku_name = suggestion.get('sku_name', 'Unknown') if hasattr(suggestion, 'get') else 'No get method'
                                            price = suggestion.get('price', 'Unknown') if hasattr(suggestion, 'get') else 'No get method'
                                            unit = suggestion.get('unit', 'Unknown') if hasattr(suggestion, 'get') else 'No get method'
